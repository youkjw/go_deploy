...
type Interface interface {
	...
	ProjectSearch(ctx context.Context, args *ProjectSearchArgs) (projects []*Project, count int, err error)
	ProjectCreate(ctx context.Context, project *Project) error
	ProjectUpdate(ctx context.Context, project *Project) error
